...
int buscar_indice(Lista lista, int valor) {
    ...
    int indice = 1; // Comenzamos desde 1 para que coincida con la posición que entendiria el usuario
    while (actual != NULL) {
...
pnodo buscar_por_indice(Lista lista, int indice) {
    pnodo actual = lista.inicio;
    int contador = 1;
    while (actual != NULL) {
        if (contador == indice) {
    ...
    return NULL; // No existe ese índice
}
...
int main() {
    ...
    do {
        ...
        cout << "6. Buscar indice de un valor\n";
        cout << "7. Buscar valor por indice\n";
        cout << "8. Salir\n";
        cout << "Ingrese opcion: ";
        cin >> opcion;
        ...
        switch(opcion) {
            ...
            case 6: {
                ...
                if (indice != -1)
                    cout << "El valor " << valor << " esta en la posicion: " << indice << endl;
                else
            ...
            case 7: {
                ...
                cin >> indice;
                pnodo nodo = buscar_por_indice(lista, indice);
                if (nodo != NULL)
                    cout << "El valor en la posicion " << indice << " es: " << nodo->dato << endl;
                else
                    cout << "No existe la posicion " << indice << " en la lista." << endl;
                break;
            }
            case 8:
                cout << "Saliendo..." << endl;
